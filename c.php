						...
						<div class="shop_bar clearfix">
							<div class="shop_product_count">
								...
								<?php 
									 ...
									 $trs = 'C';
                                     $get_album = "SELECT * FROM  fleet WHERE class= '$trs' ";
                            ...
                            <div class="product_item">
								...
								<div class="product_content">
									<div class="product_name">
										<div>
											<a href="album.php<?php echo '?id='.$row['fleet_id']; ?>" tabindex="0">
										        <?php echo $row['model'];?>
									        </a>
									    </div>
									</div>
